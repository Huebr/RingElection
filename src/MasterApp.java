...
public class MasterApp {
    static Map<Integer,IP> portas_dos_clientes = new HashMap<>();
        ...
        while (true) {
            ...
            synchronized (portas_dos_clientes) {//TODO caso não consiga conectar aquela porta retirar da lista.
                ...
                for ( Integer id : portas_dos_clientes.keySet()) {
                    try{
                        Socket client = new Socket(portas_dos_clientes.get(id).getIp(),portas_dos_clientes.get(id).getPort());
    ...
    public static void main(String args[]){
        ...
        try {
            ...
            new Thread(MasterApp::updater).start();
